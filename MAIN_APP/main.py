...
def main():
    st.set_page_config(
        page_icon="🏋️‍♀️",
        page_title="AI-GYM-TRAINER-COACH",
    ...
    if "voice_pipeline" not in st.session_state:
        try:
            ...
            st.warning(f"Voice coaching disabled: {e}")
    ...
    if not workout_started:
        ...
        context = webrtc_streamer(
            ...
            rtc_configuration={"iceServers": [{"urls": ["stun:stun.l.google.com:19303"]}]},
