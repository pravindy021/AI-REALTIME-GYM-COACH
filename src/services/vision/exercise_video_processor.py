...
from detectors.biceps_curls import BicepsCurlDetector, BicepsCurlDetector
...
class VideoProcessorClass(VideoProcessorBase):
    def __init__(self):
        ...
        self._detectors = {
            ...
            "Biceps Curl (Dumbbell)": BicepsCurlDetector(),
    ...
    def _draw_overlays(self, img, metrics, ex_type):
        ...
        elif ex_type == "Biceps Curl (Dumbbell)":
    ...
    def _draw_pushups_overlays(self, img, metrics):
        h, _ = img.shape[:2]
    ...
    def _draw_curls_overlays(self, img, metrics):
        h, _ = img.shape[:2]
